...
import { formatarTelefone, validarCREF, validarSenhaForte, validarTelefone } from '../../../services/utils/validacoes';
...
export default function CadastroPersonal() {
    ...
    const handleCadastro = async (e) => {
        ...
        if (!validarTelefone(telefone)) {
            toast.error('Formato de telefone inválido! O formato correto é (14) 99482-1456');
            return;
        }
        ...
        try {
            await Personalapi.CadastrarPersonal({ nome, telefone, email, CREF, sexo, senha, aluno });
            navigate("/");
        } catch (error) {
        ...
        <div className='container-pai-cadastro-login-personal'>
            <div className="login-cadastro-personal-form-container">
                ...
                <form onSubmit={handleCadastro} className="cadastro-personal-form">
                    ...
                    <button type="submit" className="cadastro-personal-btn">Cadastrar</button>
                </form>
                <p className="login-personal-register-link">
                    Já tem uma conta? <Link to="/" className="login-personal-link">Login</Link>
                </p>
            </div>
        </div>
    );
